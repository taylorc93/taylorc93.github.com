...
geocoder.geocode({'address': totalAddress}, function(results, status){
	...
	var output={"address":address, "parkingtype":parkingtype, "price": price, "startdate":startdate, "enddate":enddate, "contact":contact, "description":description, "lat":latitude, "lon":longitude};
